    ...
    <div>
      <form onSubmit={formik.handleSubmit} className="space-y-4 p-4">
        <Grid container spacing={2}>
          <MuiGrid className="flex flex-wrap gap-5" item xs={12} component={"div" as any}>
            <input
              type="file"
              accept="image/*"
              id="fileInput"
          ...
          <MuiGrid item xs={12} sm={12} component={"div" as any}>
            <TextField
              fullWidth
              id="title"
              name="title"
          ...
          <MuiGrid item xs={12} sm={6} lg={3} component={"div" as any}>
            <TextField
              fullWidth
              id="mrp_price"
              name="mrpPrice"
          ...
          <MuiGrid item xs={12} sm={6} lg={4} component={"div" as any}>
            <FormControl
              fullWidth
